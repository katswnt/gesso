...
- guide: array of {q,a} (2-3 warm plain sentences). FIRST FIVE REQUIRED in order: (1) medium — why this material; if you contrast with an alternative it MUST be one available in the work's OWN tradition (wood vs bronze; ink-on-silk vs colour-on-paper), NEVER "oil paint" unless the work is itself a European oil painting; if medium is "" or "—", DON'T name a material—describe the visible surface, (2) subject/figures, (3) significance, (4) technique, (5) story/context. Add extra accurate {q,a} if well-supported.
