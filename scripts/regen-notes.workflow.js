...
- guide: 5-7 {q,a} (obscure works 4-5). COVER these five learning dimensions — they're the point, so include all five when the work supports them: (1) MEDIUM — why this material and what it let the maker do; if you contrast with an alternative, it MUST be one genuinely available in THIS work's own tradition and region — e.g. for a carved-wood figure: cast bronze or stone; for an ink handscroll: colour on silk; for a Mughal folio: opaque watercolour on paper. NEVER use "oil paint" as the default foil unless the work is itself a European panel/canvas painting where oil was a real choice — do not measure non-European or non-painting media against oil paint; (2) SUBJECT — who/what is shown & how to recognize it (object: what it is & its use); (3) SIGNIFICANCE — why it mattered / what was new; (4) TECHNIQUE — the craft detail to notice; (5) CONTEXT — who made it, for whom, the backstory. THEN 0-2 extra questions the specific work invites. BUT phrase EVERY question ANCHORED to THIS work — name the figure, the visible detail, the material choice, the tension — never the generic form. The five dimensions are WHAT to teach; the phrasing must be specific. So:
    MEDIUM as (match the foil to the work's OWN tradition) "Why carve this figure in hard wood rather than cast it in bronze?" — NOT "What is it made of?", and never default to oil paint for non-European or non-painting media
...
3. For each work check: id matches a source work exactly; why is one placing sentence; EXACTLY 4 cues each containing "→" and each a "<feature> → <signal>"; guide has 4-7 {q,a}, every {q,a} non-empty, and COVERS the five learning dimensions (medium, subject, significance, technique, context) when the work supports them. REJECT any question phrased as a generic template stem ("Why does it matter?", "How was it made?", "What is it made of?", "Who made it and for whom?", "What's the story behind it?", "Who is shown?", "What are we looking at?", "What technique should I notice?" or any near-paraphrase) — keep the DIMENSION but rewrite the QUESTION anchored to THIS work (a named figure/detail/material/tension), e.g. "What is it made of?" → "Why carved wood rather than cast bronze here?" (match the foil to the work's own tradition — never default to oil paint). ALSO REJECT any answer that contrasts a non-European or non-painting work against oil paint.
