...
const AUDITS = [
  ...
  ["detectors","audit-detectors.mjs"],   // bug-class dashboard (coords-outside-country, style-not-scored, etc.) — runs on every npm test so new works are scanned as they're added
