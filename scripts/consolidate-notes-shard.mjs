...
- ARTIST IDENTIFICATION = STYLE, NOT PROVENANCE: for any question about how we know WHO made it / "how can we tell it's [artist]" / attribution, the ANSWER must teach the artist's VISIBLE SIGNATURES — brushwork, palette, line, recurring motifs, faces/hands, composition habits, surface — so the player learns to RECOGNIZE OTHER works by the same hand ("what to look for to spot this artist elsewhere"). Do NOT answer with provenance, documentation, inscriptions/signatures, dating records, or "it's securely attributed/well-documented." For ANONYMOUS works, omit artist-identity questions entirely — instead teach the recognizable traits of the culture/workshop/movement.
