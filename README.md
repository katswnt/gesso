...
- **Place** — scored against the work's **correct cultural geography, not the modern map.** The nation-state is a recent, shifting construct, so scoring a 1562 Bruegel against "Belgium" (founded 1830) — or a Benin bronze against "Nigeria" — is an anachronism, and in the non-Western case a colonial one. So the "right area" is the work's **historical cultural region** where one applies (~17% of the pool: Han China, the Ottoman core, Ancient Egypt, Ukiyo-e Japan, Safavid Persia, Benin…), **else its modern country** — either earns full credit, and outside it credit decays from the true point. A stated design commitment is **parity**: the same generous historical geography for the West (the Low Countries, the pre-1861 Italian peninsula, the Russian/Soviet sphere) that the corpus already extends to ancient and non-Western art — never fluid regions for "the exotic" and rigid borders for Europe. Region choice is meant to be **period-aware** (Ottoman core for a 1600 Anatolian work, "Turkey" for a 1980 one). *Roadmap: the historical super-regions for the European/pre-national gaps are curated data, landing the same gated way as the rest of the pool.*
