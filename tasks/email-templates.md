...
<div style="background:#e9e7e0;padding:28px 16px;font-family:'Helvetica Neue',Arial,sans-serif">
  <div style="max-width:480px;margin:0 auto;background:#f6f4ee;border:1px solid #ddd8ca;border-radius:14px;padding:30px">
    <div style="font:700 12px 'IBM Plex Mono',ui-monospace,monospace;letter-spacing:.18em;text-transform:uppercase;color:#8a8472;margin-bottom:18px"><span style="display:inline-block;width:8px;height:8px;border-radius:50% 50% 50% 12%;background:#2230b8;margin-right:8px;vertical-align:middle"></span>gesso &middot; the daily art game</div>
