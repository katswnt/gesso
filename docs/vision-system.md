...
| Current approval | A one-work, hash-bound guarded Pass B approval/apply path supports explicit field-level owner approval and labeled owner edits; no calibration record is yet approved. Auto-policy and component-ledger publication remain unimplemented |
